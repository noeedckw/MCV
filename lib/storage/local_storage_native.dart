...
class LocalStorageServiceImpl implements LocalStorageService {
  ...
  VinylEntry _toEntry(VinylsTableData r) => VinylEntry(
    ...
    genres: r.genres != null
        ? (jsonDecode(r.genres!) as List).cast<String>()
        : null,
    styles: r.styles != null
        ? (jsonDecode(r.styles!) as List).cast<String>()
        : null,
    tracklist: r.tracklist != null
        ? (jsonDecode(r.tracklist!) as List)
              .map(
                (e) => TrackInfo.fromJson(Map<String, dynamic>.from(e as Map)),
              )
              .toList()
        : null,
    notes: r.notes,
    ...
    await _db
        ...
        .insert(
          VinylsTableCompanion.insert(
            ...
            genres: Value(
              vinyl.genres != null ? jsonEncode(vinyl.genres) : null,
            ),
            styles: Value(
              vinyl.styles != null ? jsonEncode(vinyl.styles) : null,
            ),
            tracklist: Value(
  ...
  Future<String?> _writeCoverIfNeeded(
    ...
    final file = File(
      p.join(coversDir.path, '${prefix}_discogs_$discogsId.jpg'),
    );
