      ...
      child: Column(
        ...
        children: [
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  child: CoverImage(localPath: entry.localCoverPath, bytes: entry.coverBytes),
                ),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: _kAccent.withValues(alpha: .5)),
                      ),
                      child: const Icon(Icons.verified_rounded, size: 12, color: _kAccent),
                    ),
                  ),
              ],
            ),
          ...
          Text(
            ...
            style: TextStyle(fontSize: 12.5, fontWeight: FontWeight.w600, color: Colors.white.withValues(alpha: .85)),
          ),
          Text(
            entry.title,
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: TextStyle(fontSize: 11.5, color: Colors.white.withValues(alpha: .5)),
          ),
        ],
      ),
    );
